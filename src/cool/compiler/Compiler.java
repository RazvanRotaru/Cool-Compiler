...
import cool.AST.DefinitionPassVisitor;
import cool.AST.ResolutionPassVisitor;
import cool.lexer.*;
import cool.parser.*;
...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ASTConstructor dorel = new ASTConstructor();
        var ast = dorel.visit(globalTree);
//        ASTPrintVisitor printVisitor = new ASTPrintVisitor();
//        ast.accept(printVisitor);
        DefinitionPassVisitor dpv = new DefinitionPassVisitor();
        ast.accept(dpv);
        
        ResolutionPassVisitor spv = new ResolutionPassVisitor();
        ast.accept(spv);
